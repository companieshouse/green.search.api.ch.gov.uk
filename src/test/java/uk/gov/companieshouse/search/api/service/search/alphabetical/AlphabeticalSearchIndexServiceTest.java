...
class AlphabeticalSearchIndexServiceTest {
    ...
    @Mock
    private SearchRequestService<Company> mockSearchRequestService;
    ...
    void searchRequestSuccessful() throws Exception {
        ...
        ResponseObject<Company> responseObject = searchIndexService.search(CORPORATE_NAME, null, null, null, REQUEST_ID);
